  ...
  const monthlyPlans = [
    {
      plan: "Basic Plan",
      price: "$7.99",
      features: ["1 User", "3 Dashboards", "Basic Analytics", "Email Support"],
    },
    {
      plan: "Standard Plan",
      price: "$14.99",
    ...
    <section className="bg-default-200 min-h-screen">
      ...
      <div className="min-h-screen flex justify-center items-center flex-col">
        <div className="mx-auto text-center">
          ...
          >
            Choose a plan that fits your needs. Here are more details about our
            offerings.
          </motion.p>
        </div>
        <motion.div
        ...
        >
          {(billingCycle === "monthly" ? monthlyPlans : yearlyPlans).map(
            (planDetails, index) => (
              <Card
                key={index}
