    ...
    <div className="min-h-screen flex items-center justify-center bg-default-200">
      <div className="max-w-lg w-full space-y-10">
        ...
        <form className="mt-10 space-y-8" action="#" method="POST">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input id="remember-me" name="remember-me" type="checkbox" className="h-5 w-5 text-emphasis focus:ring-emphasis border-secondary-100 rounded" style={{ accentColor: "#252A34" }}/>
              <label htmlFor="remember-me" className="ml-3 block text-sm text-gray-200">Remember me</label>
            </div>
  
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-emphasis hover:text-emphasis-light cursor-pointer">Forgot your password?</Link>
            </div>
          </div>
        ...
        <div className="text-center text-sm text-primary">
          Don't have an account? <Link to="/signup" className="font-medium text-emphasis hover:text-emphasis-light cursor-pointer">Register</Link>
        </div>
      </div>
    </div>
  );
