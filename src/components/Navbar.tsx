...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="relative flex justify-between items-center w-[70vw] max-w-7xl mx-auto px-4 lg:px-0 cursor-pointer lg-w-[90vw]">
          ...
          <div className="hidden space-x-8 items-center lg:flex">
            ...
            <Link
              to="/pricing"
              className="hover:text-emphasis text-primary text-lg md:text-xl"
            >
              Pricing
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {user && user.username ? (
              <Link
                to="/dashboard"
                className="flex items-center space-x-1 hover:text-emphasis text-primary text-lg md:text-xl"
              >
                {user.username}
              </Link>
            ) : (
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-gray-800 min-w-[90vw]">
            <div className="flex flex-col items-center space-y-4 py-6">
              ...
              <Link
                to="/pricing"
                className="hover:text-emphasis text-primary text-lg"
              >
                Pricing
              </Link>
